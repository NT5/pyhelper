...
class pyhelper_gui ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		song_box = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, _(u"Canción") ), wx.VERTICAL )
		...
		self.toggle_file = wx.CheckBox( self, wx.ID_ANY, _(u"Guardar Archivo"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.toggle_post = wx.CheckBox( self, wx.ID_ANY, _(u"Enviar POST"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.menu_configfile = wx.MenuItem( self.m_menu1, wx.ID_ANY, _(u"Archivo"), wx.EmptyString, wx.ITEM_NORMAL )
		...
		self.pyhelper_menu.Append( self.m_menu1, _(u"Configuración") ) 
		...
		# Connect Events
		self.Bind( wx.EVT_CLOSE, self.close_form )
...
class cf_dialogpost ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		sbSizer5 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, _(u"Configuración") ), wx.VERTICAL )
		...
		self.m_textCtrl41 = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 300,-1 ), 0 )
		...
		self.m_textCtrl411 = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 300,-1 ), 0 )
		gSizer5.Add( self.m_textCtrl411, 0, wx.ALL|wx.ALIGN_RIGHT, 5 )
		
		
		sbSizer5.Add( gSizer5, 1, wx.EXPAND, 5 )
		
		self.m_button4 = wx.Button( self, wx.ID_ANY, _(u"Guardar"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		# Connect Events
		self.Bind( wx.EVT_INIT_DIALOG, self.cf_init )
...
class cf_dialogfile ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"Output File"), pos = wx.DefaultPosition, size = wx.Size( 289,158 ), style = wx.DEFAULT_DIALOG_STYLE|wx.STAY_ON_TOP )
		
		self.SetSizeHintsSz( wx.DefaultSize, wx.DefaultSize )
		
		sb_config = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, _(u"Configuracón") ), wx.VERTICAL )
		
		gSizer2 = wx.GridSizer( 2, 2, 0, 0 )
		
		self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, _(u"Archivo"), wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_button1 = wx.Button( self, wx.ID_ANY, _(u"Guardar"), wx.DefaultPosition, wx.DefaultSize, 0 )
